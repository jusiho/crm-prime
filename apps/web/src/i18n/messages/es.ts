...
export const es: Messages = {
  ...
  inbox: {
    ...
    waitingFor: "Esperando respuesta desde hace {time}",
    awaitingCount: "{n} sin responder",
    sortRecent: "Ordenar por más recientes",
    sortRecentShort: "Recientes",
    sortWaiting: "Ordenar por más tiempo esperando",
    sortWaitingShort: "Esperando",
    channelFilter: "Número de WhatsApp",
    allChannels: "Todos los números",
    notifyEnable: "Activar avisos: sonido y notificación al llegar un mensaje",
    notifyOn: "Avisos activados (pulsa para apagarlos)",
    notifyBlocked: "El navegador bloqueó las notificaciones; el sonido sigue activo",
    back: "Volver a la lista",
    closeAndNext: "Cerrar esta conversación y pasar a la siguiente",
    closeAndNextShort: "Cerrar y siguiente",
  },
};
